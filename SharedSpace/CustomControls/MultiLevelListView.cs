...
namespace SharedSpace.CustomControls
{
	public class MultiLevelListView : View
	{
		...
		public static readonly BindableProperty GroupBackColorProperty = BindableProperty.Create(nameof(GroupBackColor), typeof(string), typeof(MultiLevelListView), "#FF4081", BindingMode.TwoWay);
		public static readonly BindableProperty ChildBackColorProperty = BindableProperty.Create(nameof(ChildBackColor), typeof(string), typeof(MultiLevelListView), "#fff5f5f5", BindingMode.TwoWay);
